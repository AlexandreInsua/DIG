	...
	private void initialize() {
		...
		btnCalculate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				sumador = new Sumador();
				textSuma.setText(sumador.sumarNumero(num1, num2, num3, num4) +" ");
			}
		});
		...
		frmSumador.getContentPane().add(btnCalculate, gbc_btnCalculate);
		...
		GridBagConstraints gbc_textSuma = new GridBagConstraints();
		gbc_textSuma.gridx = 1;
		gbc_textSuma.gridy = 6;
		frmSumador.getContentPane().add(textSuma, gbc_textSuma);
