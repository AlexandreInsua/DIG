...
public class Teoria15_ConversorMayusculasServidor implements Runnable {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Teoria15_ConversorMayusculasServidor window = new Teoria15_ConversorMayusculasServidor();
	 ...
	 */
	public Teoria15_ConversorMayusculasServidor() {
		initialize();
	}
