...
public class Teoria15_ConversorMayusculasCliente
{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Teoria15_ConversorMayusculasCliente window = new Teoria15_ConversorMayusculasCliente();
	 ...
	 */
	public Teoria15_ConversorMayusculasCliente() {
		initialize();
	}
